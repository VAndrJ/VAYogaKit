...
final class YGNodeTests: XCTestCase {
    ...
    func test_node_top() {
        ...
        XCTAssertNotEqual(expectedPointValue, node.top)

        node.top = expectedPointValue

        XCTAssertEqual(expectedPointValue, node.top)
    }
    ...
    func test_node_right() {
        ...
        XCTAssertNotEqual(expectedPointValue, node.right)

        node.right = expectedPointValue

        XCTAssertEqual(expectedPointValue, node.right)
    }

    @MainActor
    func test_node_bottom() {
        var node = createNode()
        let expectedPointValue: YGValue = .point(value: 10)

        XCTAssertNotEqual(expectedPointValue, node.bottom)

        node.bottom = expectedPointValue

        XCTAssertEqual(expectedPointValue, node.bottom)
    }

    @MainActor
    func test_node_start() {
        var node = createNode()
        let expectedPointValue: YGValue = .point(value: 10)

        XCTAssertNotEqual(expectedPointValue, node.start)

        node.start = expectedPointValue

        XCTAssertEqual(expectedPointValue, node.start)
    }
    ...
    func test_node_end() {
        ...
        XCTAssertNotEqual(expectedPointValue, node.end)

        node.end = expectedPointValue

        XCTAssertEqual(expectedPointValue, node.end)
    }
    ...
    @MainActor
    func test_node_borderTopWidth() {
        var node = createNode()
        let expected: Float = 0.5

        XCTAssertNotEqual(expected, node.borderTopWidth)

        node.borderTopWidth = expected

        XCTAssertEqual(expected, node.borderTopWidth)
    }

    @MainActor
    func test_node_borderRightWidth() {
        var node = createNode()
        let expected: Float = 0.5

        XCTAssertNotEqual(expected, node.borderRightWidth)

        node.borderRightWidth = expected

        XCTAssertEqual(expected, node.borderRightWidth)
    }

    @MainActor
    func test_node_borderBottomWidth() {
        var node = createNode()
        let expected: Float = 0.5

        XCTAssertNotEqual(expected, node.borderBottomWidth)

        node.borderBottomWidth = expected

        XCTAssertEqual(expected, node.borderBottomWidth)
    }

    @MainActor
    func test_node_borderStartWidth() {
        var node = createNode()
        let expected: Float = 0.5

        XCTAssertNotEqual(expected, node.borderStartWidth)

        node.borderStartWidth = expected

        XCTAssertEqual(expected, node.borderStartWidth)
    }

    @MainActor
    func test_node_borderEndWidth() {
        var node = createNode()
        let expected: Float = 0.5

        XCTAssertNotEqual(expected, node.borderEndWidth)

        node.borderEndWidth = expected

        XCTAssertEqual(expected, node.borderEndWidth)
    }

    @MainActor
    func test_node_borderWidth() {
        var node = createNode()
        let expected: Float = 0.5

        XCTAssertNotEqual(expected, node.borderWidth)

        node.borderWidth = expected

        XCTAssertEqual(expected, node.borderWidth)
    }

    @MainActor
    func test_node_columnGap() {
        var node = createNode()
        let expected: Float = 0.5

        XCTAssertNotEqual(expected, node.columnGap)

        node.columnGap = expected

        XCTAssertEqual(expected, node.columnGap)
    }
    ...
    func test_node_gap() {
        ...
        XCTAssertNotEqual(expected, node.gap)

        node.gap = expected

        XCTAssertEqual(expected, node.gap)
    }
